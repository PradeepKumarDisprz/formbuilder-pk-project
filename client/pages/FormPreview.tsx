...
import { FormSchema, createDefaultForm } from "@/lib/form-schema";
...
export default function FormPreview() {
  ...
  useEffect(() => {
    // In a real app, this would fetch the form from a backend using formId
    // For now, we'll use a demo form
